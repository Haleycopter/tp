...
| EMAIL            | 1. Can be empty<br>2.  Emails should be of the format `local-part@domain`, where `local-part` should:<br/> **a.** contain only alphanumeric characters and `+_.-`<br/> **b.** not start or end with `+_.-`<br/> **c.** not contain consecutive `+_.-`<br/>3. and `domain` is made of **at least two** domain labels where each label should:<br> **a.** be separated by a period (`.`)<br/> **b.** contain only alphanumeric characters and hyphens<br/> **c.** not contain consecutive hyphens<br/> **d.** start and end only with alphanumeric characters<br/> **e.** be at least 2 characters long for the last domain label<br/> | case-*sensitive* comparison                                      | Leading, trailing and internal whitespaces will be trimmed.                                                                                                                                                                                                |

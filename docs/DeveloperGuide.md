...
| `* *`    | user who is prone to typos                                                    | be able to undo my immediate previous command                                                                      | efficiently restore immediate past details without having to check what they originally were                  |
...
| `* `     | user who is dealing with employee qualifications                              | filter out "No Expiry" certificates during an expiry search                                                        | only see employees whose certifications are already past a deadline                                           |
...
9. **Add more flexibility to Name validation**: Currently, the Name field does not accept hyphens, apostrophes, numbers and some other uniquely genuine names. We plan to accept more of such unique names by increasing the flexibility of our Name input validation in the future.
